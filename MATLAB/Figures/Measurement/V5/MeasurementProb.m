function [Prob, indexx, TotalTime] = MeasurementProb(Levels, RabiFreqs, SweepRates, FreqsCare, WhichTransfers, Detuning)
...
for i = 1:Levels-1
    ...
    [prob, indexx] = max(prob);
    %Calculate transfer time for each sweeprate
    TransferTime = 2*Detuning./SweepMat(indexx);
