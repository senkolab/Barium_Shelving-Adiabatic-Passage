function[Prob] = Prob6(Linewidth, Rabi, Sweep, Freqss, Fidelity, Level, Clebsch, Detuning, Order)
G = getGlobals();
if G.OffResErrorOn
    OProb = OffResonantError(Freqss, Level, Clebsch, Rabi, Detuning, Order, G.Eta);
else
    OProb = 1;
end
