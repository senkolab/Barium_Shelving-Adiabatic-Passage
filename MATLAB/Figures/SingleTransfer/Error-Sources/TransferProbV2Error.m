function [Prob, TotalTime] = TransferProbV2Error(G, SweepRates, RabiFreqs, Levels, Level1, Level2, LevelsG, LevelsP, Single)
...
Prob = Prob.*Prob6(G, Linewidth, RabiMat, SweepMat, Freqs, F, WhichTransition, Detuning);
